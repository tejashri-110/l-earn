            ...
            <Navbar expand="lg" fixed="top" className="navbar nav-whole">
                <Container className="nav-c">
                    <Navbar.Brand href="/" className="nav-brand">
                        {/* <img src={brand} alt="logo" /> */}L(Earn)
                    </Navbar.Brand>
                    <Navbar.Toggle aria-controls="responsive-navbar-nav" />
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="nav me-auto">
                            <Nav.Link href={auth ? "/addfood" : "/login"} className="nav-txt-rd first">Learn</Nav.Link>
                            <Nav.Link href={"/needhelp"} className="nav-txt-rd">Modules</Nav.Link>
